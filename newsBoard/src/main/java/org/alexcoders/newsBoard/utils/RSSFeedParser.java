package org.alexcoders.newsBoard.utils;
...
public class RSSFeedParser {
	...
	static final String MEDIA_THUMBNAIL = "thumbnail";
				...
				if (event.isStartElement()) {
					...
					case MEDIA_THUMBNAIL:
						if (event instanceof StartElementEvent) {
							thumbnail = ((StartElementEvent) event).getAttributeByName(new QName("url")).getValue();
						}
						break;
					case PUB_DATE:
